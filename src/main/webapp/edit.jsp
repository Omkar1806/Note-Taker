   ...
   %>
    <form action="UpdateServlet" method="post">
	  ...
	  <div class="form-group">
	    ...
	    <textarea name="content" required id="content" placeholder="Enter your content here " class="form-control" style=height:300px style=width:50px><%=note.getContent() %></textarea>
	  </div>
